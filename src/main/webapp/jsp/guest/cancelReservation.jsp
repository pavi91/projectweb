...
<head>
    ...
    <style>
        ...
        button { padding: 10px 20px; background: #e74c3c; color: white; border: none; border-radius: 4px; cursor: pointer; margin-top: 12px; }
...
<body>
    <div class="header"><h2>Cancel Reservation</h2></div>
    <div class="container">
        <div class="card">
            <%
        ...
        <a class="btn" href="${pageContext.request.contextPath}/reservation/search">Back to Search</a>
    </div>
</body>
</html>
