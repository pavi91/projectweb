...
<head>
    ...
    <style>
        ...
        button { padding: 10px 20px; background: #3498db; color: white; border: none; border-radius: 4px; cursor: pointer; margin-top: 12px; }
...
<body>
    <div class="header"><h2>Guest Check-In</h2></div>
    <div class="container">
        <div class="card">
            <%
            ...
            <form method="post" action="${pageContext.request.contextPath}/frontdesk/checkin">
