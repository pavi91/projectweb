...
<body>
    <div class="header"><h2>Staff Account Created</h2></div>
    <div class="container">
        <div class="card">
            <p class="success"><%= request.getAttribute("message") != null ? request.getAttribute("message") : "Staff account created successfully." %></p>
        </div>
        <a class="btn" href="${pageContext.request.contextPath}/admin/staff">Create Another</a>
