...
<head>
    ...
    <style>
        ...
        button { padding: 10px 20px; background: #8e44ad; color: white; border: none; border-radius: 4px; cursor: pointer; margin-top: 12px; }
...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin/maintenance">
                <label>Room ID:</label>
                ...
                <select name="status" required>
                    ...
                    <option value="AVAILABLE">Available (Maintenance Complete)</option>
                </select>
